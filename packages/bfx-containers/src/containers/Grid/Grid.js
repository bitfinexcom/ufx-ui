import {
  Classes, PROP_LAYOUT_CONFIG, withResponsive,
} from '@ufx-ui/core'
import { defaultUrlPair } from '@ufx-ui/utils'
...
const Grid = (props) => {
  ...
  }, [layoutConfig, setCurrentLayoutConfig])
...
export default withResponsive(memo(Grid))
